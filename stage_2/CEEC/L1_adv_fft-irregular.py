...
CUDA_VISIBLE_DEVICES=4 python CEEC/L1_adv_fft-irregular.py --dataset dtd --use_irregular 1
CUDA_VISIBLE_DEVICES=2 python CEEC/L1_adv_fft-irregular.py --dataset paris_streetview --use_irregular 1
CUDA_VISIBLE_DEVICES=1 python CEEC/L1_adv_fft-irregular.py --dataset celeba --use_irregular 1
