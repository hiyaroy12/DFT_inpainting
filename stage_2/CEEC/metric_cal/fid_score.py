#https://github.com/knazeri/edge-connect/blob/master/scripts/fid_score.py
#python CEEC/metric_cal/fid_score.py --path [path to validation, path to model output] --gpu [GPU id to use]
#python ./CEEC/metric_cal/fid_score.py --path ./CEEC_only_infer_results/paris_streetview_images/clean/ ./CEEC_only_infer_results/paris_streetview_images/reconstructed/ --gpu 8
