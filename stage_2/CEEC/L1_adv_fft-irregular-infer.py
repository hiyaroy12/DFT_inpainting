...
CUDA_VISIBLE_DEVICES=8 python CEEC/L1_adv_fft-irregular-infer.py --dataset dtd --use_irregular 1 --perc_test_mask 0.2
CUDA_VISIBLE_DEVICES=4 python CEEC/L1_adv_fft-irregular-infer.py --dataset paris_streetview --use_irregular 1 --perc_test_mask 0.1

CUDA_VISIBLE_DEVICES=2 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.1
CUDA_VISIBLE_DEVICES=3 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.2
CUDA_VISIBLE_DEVICES=4 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.3
CUDA_VISIBLE_DEVICES=5 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.4
CUDA_VISIBLE_DEVICES=6 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.5
CUDA_VISIBLE_DEVICES=7 python CEEC/L1_adv_fft-irregular-infer.py --dataset celeba --use_irregular 1 --perc_test_mask 0.6
"""
