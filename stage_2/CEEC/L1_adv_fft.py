...
CUDA_VISIBLE_DEVICES=0 python CEEC/L1_adv_fft.py --n_epochs 300 --dataset dtd --use_regular 1
CUDA_VISIBLE_DEVICES=1 python CEEC/L1_adv_fft.py --dataset paris_streetview --use_regular 1
CUDA_VISIBLE_DEVICES=8 python CEEC/L1_adv_fft.py --dataset svhn --n_epochs 300 --use_regular 1
CUDA_VISIBLE_DEVICES=2 python CEEC/L1_adv_fft.py --dataset celeba --n_epochs 300 --use_regular 1
...
#os.makedirs("CEEC_fft_results/{}_images".format(opt.dataset), exist_ok=True)
